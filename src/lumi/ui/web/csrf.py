...
_BYPASS_PREFIXES: tuple[str, ...] = (
    ...
    "/api/gesture",      # vision-worker process pushing detected gestures — same trust model
    "/api/presence",     # vision-worker process pushing presence transitions — same trust model
